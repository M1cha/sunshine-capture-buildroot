...
ifeq ($(BR2_PACKAGE_FFMPEG_SUNSHINE_RKMPP)$(BR2_PACKAGE_FFMPEG_SUNSHINE_VERSION3),yy)
FFMPEG_SUNSHINE_CONF_OPTS += --enable-rkmpp
FFMPEG_SUNSHINE_DEPENDENCIES += rkmpp
else
FFMPEG_SUNSHINE_CONF_OPTS += --disable-rkmpp
endif
